...
var carro = { marca: 'Renault', modelo: 'Megane', placa: '06-03-UJ', ano: 2002, cor: 'Prata', quantasPortas: 4, assentos: 5, quantidadePessoas: 0 }
...
carro.adicionarPessoas = function(x) {
  ...
  } else if (((carro.quantidadePessoas + x) > carro.assentos) && (carro.assentos - carro.quantidadePessoas === 1)) {
