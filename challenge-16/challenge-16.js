...
var fullName = 'rodolfo-kobe-sales';
var nameFinal = fullName.split('-').map(function(name) {
...
*/
console.log( '\nMeus amigos:' );
var arrayNames = ['Rodolfo', 'Larissa', 'Maria Eduarda', 'Rafaella'];
var stringNames = arrayNames.reduce(function(acumulado, atual, index){
